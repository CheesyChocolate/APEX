...
\begin{frame}{QSAR Model Architecture}
  \begin{columns}[T]
    ...
    \begin{column}{0.45\textwidth}
      ...
      \end{alertblock}
      \vspace{0.25cm}
      \begin{exampleblock}{Persistence}
        Model serialised to \texttt{\{target\_id\}.pkl};
        reused on subsequent prediction calls.
      \end{exampleblock}
    \end{column}
  \end{columns}
\end{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.47\textwidth}
      ...
      \begin{exampleblock}{Why Diversity?}
        Similar scaffolds share binding modes — diversity
        maximises binding-pocket exploration at docking.
      \end{exampleblock}
    \end{column}
  \end{columns}
\end{frame}
